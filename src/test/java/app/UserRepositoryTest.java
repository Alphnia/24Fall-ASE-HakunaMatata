...
public class UserRepositoryTest {
  ...
  public void testSaveAndFindById() {
    ...
    User user = new User("John Doe", "john.doe@example.com", "password123", 
          "{\"language\":\"en\"}", "{\"lat\":37.7749,\"lng\":-122.4194}");
  ...
  public void testFindByName() {
    // Create a new user
    User user = new User("Alice Smith", "alice@example.com", "hashed_password", 
          "{\"language\":\"en\"}", "{\"lat\":40.7128,\"lng\":-74.0060}");
  ...
  public void testFindByEmail() {
    // Create a new user
    User user = new User("Bob Johnson", "bob@example.com", "hashed_password", 
          "{\"language\":\"en\"}", "{\"lat\":34.0522,\"lng\":-118.2437}");
